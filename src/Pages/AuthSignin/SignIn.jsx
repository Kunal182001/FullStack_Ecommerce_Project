...
const SignIn = () => {
    ...
    return (
        <div className=" w-full h-screen flex justify-center items-center bg-gradient-to-b from-blue-100 via-indigo-100 to-purple-100 ">
            <div className=' w-[90%] md:w-[25%] h-[90%] bg-white rounded-xl flex flex-col items-center p-4 gap-8 '>
                ...
                <form onSubmit={handleSignin} className='w-full flex flex-col items-start font-robotoCondensed p-5 gap-4'>
                    ...
                    <div className="w-[40%] h-[50px] flex flex-col items-start mt-1 group">
                        <p className="w-full font-medium text-blue-800 group-hover:text-black transition-all duration-300 ease-in-out">
                            Forgot Password?
                        </p>
                    ...
                    <div className='w-full h-[50px] flex justify-between items-center cursor-pointer'>
                        <button className='w-[47%] h-full text-[18px] bg-blue-800 font-semibold rounded-2xl text-white flex justify-center items-center hover:bg-blue-900'>
                            Sign In
                        </button>
                        <NavLink to='/' className='w-[47%] h-full'>
                            <div className='w-full h-full text-[18px] bg-white border-[1px] font-semibold rounded-2xl border-blue-800 text-blue-800 flex justify-center items-center'>
                                Cancel
                            </div>
                        </NavLink>
                    </div>
                    ...
                    <div onClick={handleSigninWithGoogle} className='w-full h-[50px] border-[1px] border-blue-800 rounded-xl flex justify-center gap-2 items-center cursor-pointer'>
                    ...
                    <NavLink to='/access' className="w-full">
                        <p className='w-full text-xl font-medium flex justify-center items-center mt-2'>Login using Admin</p>
                    </NavLink>
                </form>
            </div>
            {isloading && (
