            ...
            <div className='w-[90%] md:w-[37%] relative  bg-white rounded-xl flex flex-col items-center p-4 '>
                ...
                <form onSubmit={handleSignUp} className='w-full relative flex flex-col items-start font-robotoCondensed p-5 gap-4'>
                    ...
                    <div className='w-full h-[50px] flex justify-between items-center cursor-pointer'>
                        <button type='submit' className='w-[47%] h-full text-[18px] bg-blue-800 font-semibold rounded-2xl text-white flex justify-center items-center hover:bg-blue-900'>
                            Sign Up
                        </button>
                    ...
                    <div onClick={handleSignUpWithGoogle} className='w-full h-[50px] border-[1px] border-blue-800 rounded-xl flex justify-center gap-2 items-center cursor-pointer'>
